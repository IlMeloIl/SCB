...
public class EmprestimoPanel extends JPanel {
    ...
    private void realizarEmprestimo() {
        ...
        try {
            ...
            boolean temCartaoPrincipal = cartoes != null && cartoes.stream()
                .anyMatch(CartaoCredito::isPrincipal);
            ...
            if (confirm == JOptionPane.YES_OPTION) {
                ...
                Long trancaId = totem.getTrancas().stream()
        ...
        public String toString() {
            return totem.getLocalizacao() + " - " + 
                   totem.getTrancas().stream()
                       .filter(t -> t.getStatus() == StatusTranca.OCUPADA && 
                                  t.getBicicleta() != null && 
                                  t.getBicicleta().getStatus() == StatusBicicleta.DISPONIVEL)
                       .count() + " bicicletas disponíveis";
        }
    }
}